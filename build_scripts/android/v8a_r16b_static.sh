...
if [ ${with_ffmpeg} == "ON" ];then
	export PKG_CONFIG_LIBDIR=/data/wensha2/tool/ffmpeg4.2.9/install/aarch64-linux-android-ffmpeg4.2.9/lib/pkgconfig
    export PKG_CONFIG_PATH=/data/wensha2/tool/ffmpeg4.2.9/install/aarch64-linux-android-ffmpeg4.2.9/lib/pkgconfig
	echo "################################################## WITH FFMPEG ON #################"
else
